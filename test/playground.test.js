...
[Site "https://lichess.org/mhjtnx5x"]
[Date "2016.10.15"]
[White "Anonymous"]
[Black "bnhsy"]
[Result "0-1"]
...
1. e4 c5 { B20 Sicilian Defense } 2. Qh5 e6 3. Bc4 Nf6 4. Qf3 Nc6 5. c3 Ne5 6. Qe2 Nxc4 7. Qxc4 d5 8. exd5 exd5 9. Qe2+ Be6 10. Nf3 h6 11. h3 Be7 12. Qb5+ Qd7 13. Qxd7+ Bxd7 14. Ne5 Be6 15. O-O O-O 16. Na3 a6 17. d4 cxd4 18. cxd4 Bd6 19. Be3 Bxe5 20. dxe5 Ne4 21. Nc2 Rac8 22. Nd4 Rc4 23. b3 Rc3 24. Nxe6 fxe6 25. Rac1 Rf5 26. g4 Rxc1 27. Rxc1 Rf7 28. Rc8+ Rf8 29. Rc7 Rf7 30. Rc8+ Rf8 31. Rxf8+ Kxf8 32. Kf1 Nc3 33. a4 b5 34. a5 Ke7 35. Bc5+ Kf7 36. b4 g5 37. Ke1 Nb1 38. Ke2 Na3 39. Kd3 Nc4 40. f3 Nxe5+ 41. Kd4 Nxf3+ 42. Ke3 Ne5 43. Kd4 Nc6+ 44. Ke3 e5 45. Bd6 Ke6 46. Bc5 Nd4 47. Bxd4 exd4+ 48. Kxd4 Kd6 49. Ke3 Ke5 50. Kd3 d4 51. Kd2 Ke4 52. Kd1 Kd3 53. Ke1 Kc2 54. Ke2 d3+ 55. Ke3 d2 56. Ke4 d1=Q 57. Kf5 Qd5+ { White leaves the game } 0-1`
...
describe.only('playground', () => {
	...
	async function annotation() {
		...
		const wat = await blundercheck(engine, gmoves, {reverse:true})
		// console.log(wat);
		wat.map((hm, i) => {
			console.log('---');
